...
<body>
    ...
    <div class="container mt-4">
        ...
        <h1 class="text-center mb-4">Choose the Machine and Workers for Maintenance</h1>
        ...
        <form action="/FabricToutFactoryClient2024/AddMachineWorkersToMaintenanceServlet" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="radio" name="selectedMachineId" value="<%= m.getId() %>">
                            </td>
                            <td><%= m.getId() %></td>
                            <td><%= m.getType() %></td>
                            <td><%= m.getSize() %></td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="selectedWorkerIds" value="<%= w.getId() %>">
                            </td>
                            <td><%= w.getId() %></td>
            ...
            <div class="d-flex justify-content-center mt-4">
		    	<input type="submit" class="btn btn-primary btn-lg w-100 mx-2" name="submit" id="submit" value="Next">
		    	<a href="home" class="btn btn-secondary btn-lg w-100 mx-2">Cancel</a>
			</div>
        </form>
    </div>
</body>
