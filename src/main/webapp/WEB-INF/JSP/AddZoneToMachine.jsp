...
<body>
	<h1>Choose zones where the machine will be : don't forget to choose zones from the same site and factory!</h1>

    <form action="/FabricToutFactoryClient2024/AddZoneToMachineServlet" method="POST">
        <table border="1" style="border-collapse: collapse; width: 100%;">
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><input type="checkbox" name="selectedZoneIds" value="<%= zone.getId() %>"></td>
                    <td><%= zone.toString() %></td>
                </tr>
                <% 
                        }
