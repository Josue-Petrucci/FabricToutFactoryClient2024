            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-<%= m.getStatus() == MaintenanceStatus.Completed ? "success" : "warning" %>">
                                <%= m.getStatus() %>
                            </span>
                        </td>
                        <td>
                            <a href="DetailMaintenanceServlet?id=<%= m.getId() %>" class="btn btn-sm btn-primary">
                                Details
                            </a>
                        </td>
                    </tr>
                    ...
                    %>
                    <tr>
                        <td colspan="7" class="text-center text-muted">No Maintenance Available</td>
                    </tr>
                    <% } %>
                </tbody>
            </table>
