...
<body class="bg-light">
	...
	<div class="container mt-4">
		...
		<div class="card mb-4">
			<div class="card-header bg-primary text-white">General
				Information</div>
			<div class="card-body">
				<p>
					<strong>ID:</strong>
				...
				<p>
					...
					<%=(m.getReport() != null ? m.getReport() : "No report available")%></p>
				<p>
					<strong>Status:</strong> <span
						class="badge badge-<%=m.getStatus().toString().equals("Completed") ? "success" : "warning"%>">
						<%=m.getStatus()%>
					</span>
				</p>
			</div>
		...
		<div class="card mb-4">
			<div class="card-header bg-info text-white">Manager Information
			</div>
			<div class="card-body">
				<%
				...
				<p>
					...
					<%=manager.getAddress()%></p>
				<p>
					<strong>Matricule:</strong>
					<%=manager.getMatricule()%></p>
				<%
				} else {
				%>
		...
		<div class="card mb-4">
			<div class="card-header bg-warning text-dark">Assigned Workers
			</div>
			<div class="card-body">
				<%
				...
				<ul class="list-group">
					...
					%>
					<li class="list-group-item"><strong>Name:</strong> <%=worker.getFirstname()%>
						<%=worker.getLastname()%>, <strong>Age:</strong> <%=worker.getAge()%>,
						<strong>Address:</strong> <%=worker.getAddress()%>, <strong>Matricule:</strong>
						<%=worker.getMatricule()%></li>
					<%
					}
					%>
				</ul>
		...
		<div class="card mb-4">
			<div class="card-header bg-secondary text-white">Machine
				Details</div>
			<div class="card-body">
				<%
				...
				<ul class="list-group">
					...
					for (Zone zone : zones) {
					%>
					<li class="list-group-item"><strong>Zone Letter:</strong> <%=zone.getZoneLetter()%>,
						<strong>Danger Level:</strong> <%=zone.getDangerLevel()%></li>
					<%
					}
					%>
				</ul>
		...
		%>
		<div class="alert alert-danger" role="alert">No maintenance
		...
		<div class="text-center mt-4">
			<a href="SeeAllMaintenance" class="btn btn-primary"
