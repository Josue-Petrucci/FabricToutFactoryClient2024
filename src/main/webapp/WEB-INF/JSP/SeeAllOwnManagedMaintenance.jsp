				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><span
								class="badge badge-<%=maintenance.getStatus() == MaintenanceStatus.Completed ? "success" : "warning"%>">
									<%=maintenance.getStatus()%>
							</span></td>
							<td><a
								href="DeleteMaintenanceServlet?id=<%=maintenance.getId()%>"
							...
							%>
							<td><a
								href="UpdateMaintenanceServlet?id=<%=maintenance.getId()%>&action=accept">Accept</a></td>
							<td><a
								href="UpdateMaintenanceServlet?id=<%=maintenance.getId()%>&action=reject">Reject</a></td>
							<%
							}
							%>
						</tr>
						...
						%>
						<tr>
							<td colspan="7" class="text-center text-muted">No associated
