...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="/FabricToutFactoryClient2024/AddMaintenanceServlet" method="post" class="p-4 border rounded shadow-sm bg-light">
            ...
            <div class="d-flex justify-content-center mt-4">
                <input type="submit" class="btn btn-primary btn-lg w-25 mx-2" value="Add Maintenance">
                <a href="home" class="btn btn-secondary btn-lg w-25 mx-2">Cancel</a>
            </div>
        </form>
    </div>
</body>
