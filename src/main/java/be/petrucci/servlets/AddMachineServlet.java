...
public class AddMachineServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Machine machine = new Machine(0, type, size, MachineStatus.OnOrder, zoneList.get(0).getSite(), zoneList);
		...
		request.setAttribute("success", "Success purchasing a new machine! " + "Wait for arrival!");
		getServletContext().getRequestDispatcher("/WEB-INF/JSP/Home.jsp").forward(request, response);
		return;
	}
